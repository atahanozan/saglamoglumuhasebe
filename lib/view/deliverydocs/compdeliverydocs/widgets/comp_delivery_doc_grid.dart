...
import 'package:saglamoglu_muhasebe/view/deliverydocs/compdeliverydocs/widgets/comp_grid_buttons.dart';
  ...
  Widget build(BuildContext context) {
    return GridSkeleton(
      ...
      secondTransaction: OutlinedButton(
        ...
        child: Text("Döküman Teslim Alındı"),
      ),
    );
  }
}
