...
class CompDeliveryDocsViewModel extends GetxController {
  static bool get isRegistered =>
      GetInstance().isRegistered<CompDeliveryDocsViewModel>();

  static CompDeliveryDocsViewModel get init =>
      Get.put(CompDeliveryDocsViewModel());

  static CompDeliveryDocsViewModel get instance =>
      Get.find<CompDeliveryDocsViewModel>();
  ...
  Future<void> getAllData() async {
    var res = await deliveryController.getDeliverDocList(true);
